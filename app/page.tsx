    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "A growth automation system connects your lead sources, forms, CRM or tracking tools, and follow-up workflows so that leads are captured, qualified, and followed up with automatically.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "DigiLift AI works with schools, daycares, childcare centers, and local small businesses that rely on inquiries, tours, or appointments to grow.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most clients see faster lead follow-up and better lead qualification within the first few weeks of launching their growth system.",
        },
      },
    ],
  };
            ...
            {[
              {
                step: "01",
                title: "Audit",
                description: "We review your current website, ads, lead forms, follow-up process, and reporting to identify exactly where leads are being lost.",
              },
              {
                step: "02",
                title: "Build",
                description: "We create or improve your lead funnel, automation workflows, and tracking setup based on what the audit reveals.",
              },
              {
                step: "03",
                title: "Automate",
                description: "We connect your lead sources to Google Sheets, CRM systems, email and SMS platforms, and AI-assisted follow-up workflows.",
              },
              {
                step: "04",
                title: "Optimize",
                description: "We monitor performance, improve lead quality, reduce wasted spend, and help convert more inquiries into customers over time.",
              },
            ].map((item, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="card p-8 ring-1 ring-neutral-200">
              ...
              <div className="border-t border-neutral-100 pt-6 mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Website Build", "Logo & Branding", "Cover Photos", "Enrollment Graphics", "Instagram Templates", "Contact Form", "Book a Tour Form", "GBP Reviews Display"].map((item, i) => (
              ...
              <div className="border-t border-neutral-100 pt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Claude", "Cursor", "ChatGPT", "Canva", "Google Gemini"].map((tool, i) => (
                    <span key={i} className="text-xs bg-neutral-100 text-dark/60 px-3 py-1 rounded-full">
                      {tool}
                    </span>
                  ))}
              ...
              <a href="https://www.millcreekhomechildcare.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 mt-6 text-sm font-semibold text-[#00C2A8] hover:text-[#00A890] transition-colors">
                View Live Site
            ...
            <div className="card p-8 ring-1 ring-neutral-200">
              ...
              <div className="border-t border-neutral-100 pt-6 mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Meta Lead Ads", "Lead Form Qualification", "Google Sheets Routing", "Automated Follow-up", "Lead Tracking"].map((item, i) => (
                    <span key={i} className="text-xs bg-neutral-100 text-dark/60 px-3 py-1 rounded-full">
                      {item}
                    </span>
                  ))}
              ...
              <div className="border-t border-neutral-100 pt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Meta Business Suite", "Google Sheets", "Make.com", "ChatGPT", "Claude"].map((tool, i) => (
                    <span key={i} className="text-xs bg-neutral-100 text-dark/60 px-3 py-1 rounded-full">
                      {tool}
                    </span>
                  ))}
